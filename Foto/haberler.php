						...
						<span class="thumb-info thumb-info-side-image thumb-info-no-zoom mt-xl">
							<span class="thumb-info-side-image-wrapper p-none">
								<a title="" href="demo-law-firm-news-detail.html">
									<img src="<?php echo $icerikcek['icerik_resimyolu']; ?>" class="img-responsive" alt="" style="width: 400px; height: 250px; padding: 10px;">
								</a>
							</span>
							<span>
								<span>
									...
									<span class="post-meta">
										<span><?php echo $icerikcek['icerik_zaman']; ?> | <?php echo $ayarcek['ayar_title']; ?></span>
									</span>
