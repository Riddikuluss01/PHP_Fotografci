<footer class="short" id="footer">
	<div class="container">
		<div class="row">
			<div class="col-md-5">
				...
				<p>
				<?php echo $ayarcek['ayar_description']; ?>					
				</p>
			...
			<div class="col-md-3">
				...
				<ul class="social-icons mt-lg">
					...
					<li class="social-icons-instagram"><a href="<?php echo $ayarcek['ayar_instagram']; ?>" target="_blank" title="Instagram"><i class="fa fa-instagram"></i></a></li>
				</ul>
			</div>
		</div>
	</div>
	<div class="footer-copyright">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<p>© Copyright 2017. All Rights Reserved. | <?php echo $ayarcek['ayar_author']; ?> <!--<a href="demo-law-firm-contact-us.html">Contact</a>--></p>
				</div>
			</div>
		</div>
	</div>
